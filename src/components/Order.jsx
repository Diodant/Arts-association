...
function Order() {
  ...
  return (
    ...
    <ol className="goalsList">
      ...
      <p>Церемония награждения представляет собой торжественное событие, где лауреаты получают знаки отличия и сертификаты, а также широкое признание их заслуг перед международным сообществом. Это событие становится не только праздником таланта и профессионализма, но и важным инструментом для дальнейшего развития искусственного сотрудничества в СНГ и за его пределами.</p>
